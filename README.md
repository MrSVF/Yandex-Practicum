...
| [Client churn](Client_churn) &nbsp;&nbsp; [![Open in Colab][Colab Badge]][Client churn] | Building a model for solving the binary classification problem for predicting the outflow of Beta-Bank customers. | *pandas,* *numpy,* *matplotlib,* *sklearn,* *plotly* |
...
[Client churn]:        https://colab.research.google.com/github.com/MrSVF/Yandex-Practicum/blob/main/Client_churn/Сlient%20churn.ipynb